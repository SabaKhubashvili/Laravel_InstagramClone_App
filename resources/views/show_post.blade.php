...
@section('header')
    @section('title','@'.$post->user->username.' on Instagram: "'. $post->title. '"')
    <link rel="stylesheet" href="{{asset('css/style.css')}}">
@endsection


@section('main')
<article class="post mx-auto my-auto" style="width: 600px;height:100%;">
    ...
    <div class="post__footer">       
      <div class="post__buttons"> 
        ...
        @if(isHearted($post->id) == 'hearted')
          {!! Form::model($post->user,['method'=>'POST','route'=>'unheart','id'=>'unHeartForm','class'=>'reactForm unHeartForm','style'=>'']) !!}
            <button class="post__button like unheart"  name="unheart" value="{{$post->id}}" type="submit">
              <svg
                width="24"
                height="24"
      ...
      <div class="post__infos">
        ...
        <span class="user">{{$post->created_at->diffForHumans()}}</span>
      </div>
    </div>
  </article>
