...
<body>
    ...
    <div class="container">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="input-element">
                    <?php if(isset($message)){ echo $message; } ?>
                        ...
                        <input id="name" type="text" class="inputText" placeholder="Name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                ...
                <div class="input-element">
                        ...
                        <input id="username" type="text" class="inputText" placeholder="Username" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus>
                ...
                <div class="input-element">
                    ...
                    <input id="password-confirm" type="password"  class="inputText" placeholder="Repeat-Password" name="password_confirmation" required autocomplete="new-password">
                </div>
        ...
        <div class="footer">
          <p>Already Have Accaunt?<a href="{{route('login')}}"> Log in</a></p>
        </div>
      </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="col-md-8 offset-md-4 mt-4">
                            <p>Already Have Accaunt? <a href="{{route('login')}}"  style="color: coral;"> Click Here</a> </p>
                        </div>
                    </form>
                </div>
            </div>
