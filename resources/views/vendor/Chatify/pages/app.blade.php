...
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            <nav>
                <a href="{{route('index')}}"><img style="width: 100px;" src="{{asset('images/logo/instagram_logo.png')}}" alt=""> </a>
                {{-- header buttons --}}
            ...
            <div class="messenger-listView-tabs">
                <a href="#" @if($type == 'user') class="active-tab" @endif data-view="users" style="color: black;">
