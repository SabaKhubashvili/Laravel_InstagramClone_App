            ...
            <article class="post">
              ...
              <div class="post__footer">       
                <div class="post__buttons">
                  ...
                  {!! Form::model($post->user,['method'=>'POST','route'=>'unheart','id'=>'unHeartForm','class'=>'reactForm','style'=>'']) !!}
                    <button class="post__button like"  name="unheart" value="{{$post->id}}" type="submit">
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"                   
