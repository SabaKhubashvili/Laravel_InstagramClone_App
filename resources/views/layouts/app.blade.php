...
<html lang="en">
  ...
  <body>
          ...
          <a href="#">
            ...
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                    <div class="dropdown">
                      <button style="background-color: transparent;border:none; outline:none;" class="d-flex btn btn-secondary dropdown-toggle" type="button" id="triggerId" data-toggle="dropdown" aria-haspopup="true"
                          aria-expanded="false">
                      ...
                      <div class="dropdown-menu"  aria-labelledby="triggerId">
                        <a class="dropdown-item" style="background-color:#fff !important;color:rgb(70, 64, 64) !important;"href="{{route('profile')}}"><i class="fa-solid fa-user mr-2"></i>Profile</a>
                       
                        <a class="dropdown-item " style="background-color:#fff !important;color:rgb(70, 64, 64) !important;"href="#"><i class="fa-solid fa-clock-rotate-left mr-2"></i>Your Activity</a>
                      
                        {!! Form::open(['method'=>'POST','route'=>'logout']) !!}
                        {!! Form::button('<i class="fa-solid fa-right-from-bracket mr-2"></i> Log Out',['class'=>'dropdown-item', 'style'=>'background-color:#fff !important;color:rgb(70, 64, 64) !important;','type'=>'submit']) !!}
                        {!! Form::close() !!}
                      </div>
                    </div>
                    @else
    ...
    <nav class="navbar">
        <a href="{{route('index')}}" class="navbar__button">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
        ...
        <a class="navbar__button profile-button" href="{{route('profile')}}">
